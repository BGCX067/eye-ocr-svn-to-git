...
#mvn install:install-file -Dfile=../lib/weka.jar -DgroupId=weka -DartifactId=weka -Dversion=3.6.2 -Dpackaging=jar -DgeneratePom=true

#mvn install:install-file -Dfile=../lib/aspriseOCR.jar -DgroupId=asprise -DartifactId=ocr -Dversion=1.0.0 -Dpackaging=jar -DgeneratePom=true
...
mvn install:install-file -Dfile=lib-gi.jar -DgroupId=lib-gi -DartifactId=lib-gi -Dversion=1.0.0 -Dpackaging=jar -DgeneratePom=true 
